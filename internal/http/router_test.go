...
func (d *dummyAdmin) CreateTenant(ctx context.Context, rps, burst int) (*domain.Tenant, string, error) { return &domain.Tenant{ID:"t"}, "k", nil }
...
func (d *dummyAdmin) RotateTenantAPIKey(ctx context.Context, tenantID string, gracePeriod time.Duration) (string, time.Time, error) { return "k2", time.Now().Add(gracePeriod), nil }
func (d *dummyAdmin) UpdateTenantLimits(ctx context.Context, tenantID string, rps, burst int) error { return nil }
func (d *dummyAdmin) UpdateTenantIPAllowlist(ctx context.Context, tenantID string, cidrs []string) error { return nil }
